...
* Updated the ER time series base on the most recent estimates Will A. generated with the updated CWT indicator stock time series Ryan W. provided (file [here](https://github.com/Pacific-salmon-assess/CC_coho/blob/main/Data/CO%20ERs%20by%20CUs.csv)) 
...
1. Total harvest rates have remained relatively consistent over the past 5 years, averaging ~30% in more northern areas and to ~20% in southern ones. Across all region harvest rates dipped in 2020 and have ticked slightly upward since. 
